...
[![NuGet](https://img.shields.io/nuget/v/Dryv.svg)](https://www.nuget.org/packages/Dryv)

**Core library for DRY Validation — write model validation rules in C# once, get JavaScript for the client automatically.**
