...
The JavaScript generated by the Tag Helper / HTML Helper follows this structure:
...
var myModel = {
    ...
    validators: {
        "propertyName": [{
            name: "optionalRuleName",
            group: "optionalGroupName",
    ...
    disablers: {
        "propertyName": [
            function ($m, $ctx) { return /* true to disable */ false; }
        ]
    },
    parameters: {
